...
| generated_at_utc (first trial) | 2026-02-18T02:39:58.605616Z | 2026-02-18T02:40:01Z |
| trials | 3 | 3 |
...
| --- | ---: |
| Pure processing elapsed (ms) | 42.09 ± 0.39 |
| Full analyze elapsed (ms) | 334.18 ± 2.27 |
| JSON overhead elapsed (ms) | 292.08 ± 2.63 |
| JSON overhead per analysis (ms) | 0.4868 ± 0.0044 |
| JSON overhead per token (us) | 30.2365 ± 0.2724 |
| JSON overhead ratio (%) | 87.40 ± 0.20 |
...
| --- | ---: | ---: | ---: |
| Throughput (analyses/s, higher better) | 14254.97 ± 131.57 | 2599.67 ± 36.30 | 5.48x (faster) |
| Throughput (chars/s, higher better) | 483243.33 ± 4460.09 | 88128.86 ± 1230.59 | 5.48x (faster) |
| Throughput (tokens/s, higher better) | 229504.94 ± 2118.21 | 41789.72 ± 583.53 | 5.49x (faster) |
| Avg warm latency (ms, lower better) | 0.07 ± 0.00 | 0.38 ± 0.01 | 0.18x (faster) |
| Avg warm token latency (us/token, lower better) | 4.36 ± 0.04 | 23.93 ± 0.34 | 0.18x (faster) |

## Layered Throughput Breakdown

| Layer | Throughput (mean ± std, analyses/s) |
| --- | ---: |
| Flutter pure (`token_count`) | 14254.97 ± 131.57 |
| Flutter full (`json`) | 1795.51 ± 12.21 |
| kiwipiepy current API path (`analyze`) | 2599.67 ± 36.30 |

| Derived ratio | Value |
| --- | ---: |
| Flutter pure / kiwi | 5.48x (faster) |
| Flutter full / kiwi | 0.69x (slower) |
| Flutter boundary loss (full vs pure) | 87.40% |
...
| --- | ---: | ---: | ---: |
| Init time (ms, lower better) | median 1687.99, p95 1701.67 | median 872.80, p95 878.60 | 1.93x (slower) |
...
| ---: | ---: | ---: | ---: |
| 1 | 0.59 ± 0.00 | 1.15 ± 0.01 | 0.52x (slower) |
| 10 | 5.91 ± 0.04 | 11.42 ± 0.10 | 0.52x (slower) |
| 100 | 58.93 ± 0.43 | 109.86 ± 0.92 | 0.54x (slower) |
| 1000 | 568.14 ± 4.14 | 795.87 ± 2.88 | 0.71x (slower) |

## Per-Trial Raw Snapshot

| Trial | Flutter init (ms) | Kiwi init (ms) | Flutter warm analyses/s | Kiwi warm analyses/s |
| ---: | ---: | ---: | ---: | ---: |
| 1 | 1678.97 | 879.25 | 14331.10 | 2614.45 |
| 2 | 1703.19 | 872.80 | 14103.05 | 2626.25 |
| 3 | 1687.99 | 863.28 | 14330.75 | 2558.31 |
