...
| generated_at_utc (first trial) | 2026-02-18T07:06:04.346511Z | 2026-02-18T07:06:07Z |
| trials | 3 | 3 |
...
| --- | ---: |
| Pure processing elapsed (ms) | 117.17 ± 8.28 |
| Full analyze elapsed (ms) | 138.26 ± 2.36 |
| JSON overhead elapsed (ms) | 21.09 ± 6.14 |
| JSON overhead per analysis (ms) | 0.0352 ± 0.0102 |
| JSON overhead per token (us) | 2.1833 ± 0.6360 |
| JSON overhead ratio (%) | 15.30 ± 4.71 |
...
| --- | ---: | ---: | ---: |
| Throughput (analyses/s, higher better) | 5138.55 ± 376.76 | 2398.63 ± 189.37 | 2.14x (faster) |
| Throughput (chars/s, higher better) | 174196.72 ± 12772.19 | 81313.55 ± 6419.54 | 2.14x (faster) |
| Throughput (tokens/s, higher better) | 82730.60 ± 6065.85 | 38557.97 ± 3044.07 | 2.15x (faster) |
| Avg warm latency (ms, lower better) | 0.20 ± 0.01 | 0.42 ± 0.03 | 0.47x (faster) |
| Avg warm token latency (us/token, lower better) | 12.13 ± 0.86 | 26.05 ± 2.15 | 0.47x (faster) |

## Layered Throughput Breakdown

| Layer | Throughput (mean ± std, analyses/s) |
| --- | ---: |
| Flutter pure (`token_count`) | 5138.55 ± 376.76 |
| Flutter full (`json`) | 4340.49 ± 73.97 |
| kiwipiepy current API path (`analyze`) | 2398.63 ± 189.37 |

| Derived ratio | Value |
| --- | ---: |
| Flutter pure / kiwi | 2.14x (faster) |
| Flutter full / kiwi | 1.81x (faster) |
| Flutter boundary loss (full vs pure) | 15.53% |
...
| --- | ---: | ---: | ---: |
| Init time (ms, lower better) | median 3570.64, p95 3879.53 | median 961.12, p95 1013.92 | 3.72x (slower) |
...
| ---: | ---: | ---: | ---: |
| 1 | 0.27 ± 0.02 | 1.04 ± 0.05 | 0.26x (slower) |
| 10 | 2.74 ± 0.17 | 10.32 ± 0.53 | 0.27x (slower) |
| 100 | 27.29 ± 1.65 | 99.31 ± 4.69 | 0.27x (slower) |
| 1000 | 260.34 ± 14.27 | 722.13 ± 16.12 | 0.36x (slower) |

## Per-Trial Raw Snapshot

| Trial | Flutter init (ms) | Kiwi init (ms) | Flutter warm analyses/s | Kiwi warm analyses/s |
| ---: | ---: | ---: | ---: | ---: |
| 1 | 3913.85 | 1019.79 | 5569.22 | 2501.09 |
| 2 | 3476.67 | 961.12 | 4869.93 | 2514.69 |
| 3 | 3570.64 | 918.70 | 4976.49 | 2180.11 |
