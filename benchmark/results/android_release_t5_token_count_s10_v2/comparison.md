...
| generated_at_utc (first trial) | 2026-02-18T00:14:39.891970Z | 2026-02-18T00:14:52Z |
| trials | 5 | 5 |
...
| --- | ---: |
| Pure processing elapsed (ms) | 275.52 ± 42.59 |
| Full analyze elapsed (ms) | 335.54 ± 82.52 |
| JSON overhead elapsed (ms) | 60.13 ± 79.24 |
| JSON overhead per analysis (ms) | 0.1002 ± 0.1321 |
| JSON overhead per token (us) | 6.2245 ± 8.2032 |
| JSON overhead ratio (%) | 14.81 ± 18.16 |
...
| --- | ---: | ---: | ---: |
| Throughput (analyses/s, higher better) | 2214.79 ± 301.30 | 3510.74 ± 86.29 | 0.63x (slower) |
| Throughput (chars/s, higher better) | 75081.44 ± 10213.94 | 119014.22 ± 2925.10 | 0.63x (slower) |
| Throughput (tokens/s, higher better) | 35658.15 ± 4850.87 | 56435.21 ± 1387.05 | 0.63x (slower) |
| Avg warm latency (ms, lower better) | 0.46 ± 0.07 | 0.28 ± 0.01 | 1.61x (slower) |
| Avg warm token latency (us/token, lower better) | 28.52 ± 4.41 | 17.73 ± 0.44 | 1.61x (slower) |

## Layered Throughput Breakdown

| Layer | Throughput (mean ± std, analyses/s) |
| --- | ---: |
| Flutter pure (`token_count`) | 2214.79 ± 301.30 |
| Flutter full (`json`) | 1877.74 ± 458.67 |
| kiwipiepy current API path (`analyze`) | 3510.74 ± 86.29 |

| Derived ratio | Value |
| --- | ---: |
| Flutter pure / kiwi | 0.63x (slower) |
| Flutter full / kiwi | 0.53x (slower) |
| Flutter boundary loss (full vs pure) | 15.22% |
...
| --- | ---: | ---: | ---: |
| Init time (ms, lower better) | median 3268.46, p95 4028.02 | median 847.02, p95 1053.33 | 3.86x (slower) |
...
| ---: | ---: | ---: | ---: |
| 1 | 0.30 ± 0.05 | 1.16 ± 0.18 | 0.26x (slower) |
| 10 | 3.04 ± 0.46 | 11.53 ± 1.82 | 0.26x (slower) |
| 100 | 30.01 ± 4.50 | 111.90 ± 17.23 | 0.27x (slower) |
| 1000 | 267.39 ± 39.28 | 866.99 ± 106.91 | 0.31x (slower) |

## Per-Trial Raw Snapshot

| Trial | Flutter init (ms) | Kiwi init (ms) | Flutter warm analyses/s | Kiwi warm analyses/s |
| ---: | ---: | ---: | ---: | ---: |
| 1 | 3576.08 | 1068.30 | 2139.52 | 3564.74 |
| 2 | 2810.43 | 847.02 | 2354.09 | 3492.95 |
| 3 | 4141.00 | 993.45 | 1728.96 | 3388.77 |
| 4 | 2956.74 | 731.44 | 2506.48 | 3616.84 |
| 5 | 3268.46 | 773.95 | 2344.92 | 3490.42 |
