...
| generated_at_utc (first trial) | 2026-02-18T02:49:03.244793Z | 2026-02-18T02:49:05Z |
| trials | 1 | 1 |
...
| --- | ---: |
| Pure processing elapsed (ms) | 41.64 ± 0.00 |
| Full analyze elapsed (ms) | 70.55 ± 0.00 |
| JSON overhead elapsed (ms) | 28.91 ± 0.00 |
| JSON overhead per analysis (ms) | 0.0482 ± 0.0000 |
| JSON overhead per token (us) | 2.9922 ± 0.0000 |
| JSON overhead ratio (%) | 40.97 ± 0.00 |
...
| --- | ---: | ---: | ---: |
| Throughput (analyses/s, higher better) | 8505.09 ± 0.00 | 2644.29 ± 0.00 | 3.22x (faster) |
| Throughput (chars/s, higher better) | 288322.51 ± 0.00 | 89641.55 ± 0.00 | 3.22x (faster) |
| Throughput (tokens/s, higher better) | 136931.93 ± 0.00 | 42507.02 ± 0.00 | 3.22x (faster) |
| Avg warm latency (ms, lower better) | 0.12 ± 0.00 | 0.38 ± 0.00 | 0.31x (faster) |
| Avg warm token latency (us/token, lower better) | 7.30 ± 0.00 | 23.53 ± 0.00 | 0.31x (faster) |

## Layered Throughput Breakdown

| Layer | Throughput (mean ± std, analyses/s) |
| --- | ---: |
| Flutter pure (`token_count`) | 14408.88 ± 0.00 |
| Flutter full (`json`) | 8505.09 ± 0.00 |
| kiwipiepy current API path (`analyze`) | 2644.29 ± 0.00 |

| Derived ratio | Value |
| --- | ---: |
| Flutter pure / kiwi | 5.45x (faster) |
| Flutter full / kiwi | 3.22x (faster) |
| Flutter boundary loss (full vs pure) | 40.97% |
...
| --- | ---: | ---: | ---: |
| Init time (ms, lower better) | median 1714.80, p95 1714.80 | median 856.82, p95 856.82 | 2.00x (slower) |
...
| ---: | ---: | ---: | ---: |
| 1 | 0.58 ± 0.00 | 1.17 ± 0.00 | 0.50x (slower) |
| 10 | 5.83 ± 0.00 | 11.62 ± 0.00 | 0.50x (slower) |
| 100 | 57.92 ± 0.00 | 111.78 ± 0.00 | 0.52x (slower) |
| 1000 | 545.74 ± 0.00 | 809.72 ± 0.00 | 0.67x (slower) |

## Per-Trial Raw Snapshot

| Trial | Flutter init (ms) | Kiwi init (ms) | Flutter warm analyses/s | Kiwi warm analyses/s |
| ---: | ---: | ---: | ---: | ---: |
| 1 | 1714.80 | 856.82 | 8505.09 | 2644.29 |
