...
| generated_at_utc (first trial) | 2026-02-17T23:22:06.137269Z | 2026-02-17T23:22:08Z |
| trials | 5 | 5 |
...
| --- | ---: |
| Pure processing elapsed (ms) | 226.24 ± 13.35 |
| Full analyze elapsed (ms) | 254.65 ± 19.00 |
| JSON overhead elapsed (ms) | 28.42 ± 8.08 |
| JSON overhead per analysis (ms) | 0.0474 ± 0.0135 |
| JSON overhead per token (us) | 2.9417 ± 0.8361 |
| JSON overhead ratio (%) | 11.05 ± 2.58 |
...
| --- | ---: | ---: | ---: |
| Throughput (analyses/s, higher better) | 2659.19 ± 150.83 | 3590.32 ± 85.19 | 0.74x (slower) |
| Throughput (chars/s, higher better) | 90146.57 ± 5112.99 | 121711.90 ± 2887.78 | 0.74x (slower) |
| Throughput (tokens/s, higher better) | 42812.97 ± 2428.29 | 57714.42 ± 1369.35 | 0.74x (slower) |
| Avg warm latency (ms, lower better) | 0.38 ± 0.02 | 0.28 ± 0.01 | 1.35x (slower) |
| Avg warm token latency (us/token, lower better) | 23.42 ± 1.38 | 17.33 ± 0.42 | 1.35x (slower) |

## Layered Throughput Breakdown

| Layer | Throughput (mean ± std, analyses/s) |
| --- | ---: |
| Flutter pure (`token_count`) | 2659.19 ± 150.83 |
| Flutter full (`json`) | 2366.64 ± 176.25 |
| kiwipiepy current API path (`analyze`) | 3590.32 ± 85.19 |

| Derived ratio | Value |
| --- | ---: |
| Flutter pure / kiwi | 0.74x (slower) |
| Flutter full / kiwi | 0.66x (slower) |
| Flutter boundary loss (full vs pure) | 11.00% |
...
| --- | ---: | ---: | ---: |
| Init time (ms, lower better) | median 1325.71, p95 1415.70 | median 683.38, p95 914.72 | 1.94x (slower) |
...
| ---: | ---: | ---: | ---: |
| 1 | 0.74 ± 0.03 | 1.38 ± 0.21 | 0.54x (slower) |
| 10 | 7.42 ± 0.30 | 13.71 ± 2.11 | 0.54x (slower) |
| 100 | 72.35 ± 2.94 | 132.45 ± 19.76 | 0.55x (slower) |
| 1000 | 581.02 ± 23.43 | 990.77 ± 114.22 | 0.59x (slower) |

## Per-Trial Raw Snapshot

| Trial | Flutter init (ms) | Kiwi init (ms) | Flutter warm analyses/s | Kiwi warm analyses/s |
| ---: | ---: | ---: | ---: | ---: |
| 1 | 1375.45 | 787.93 | 2694.38 | 3465.67 |
| 2 | 1280.62 | 946.41 | 2621.08 | 3688.78 |
| 3 | 1425.77 | 683.38 | 2422.36 | 3550.47 |
| 4 | 1325.71 | 657.75 | 2737.38 | 3619.80 |
| 5 | 1324.33 | 636.15 | 2820.76 | 3626.88 |
