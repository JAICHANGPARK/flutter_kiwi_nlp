...
| generated_at_utc (first trial) | 2026-02-18T03:05:20.086071Z | 2026-02-18T03:05:27Z |
| trials | 3 | 3 |
...
| --- | ---: |
| Pure processing elapsed (ms) | 160.57 ± 38.30 |
| Full analyze elapsed (ms) | 209.16 ± 76.08 |
| JSON overhead elapsed (ms) | 48.59 ± 37.79 |
| JSON overhead per analysis (ms) | 0.0810 ± 0.0630 |
| JSON overhead per token (us) | 5.0300 ± 3.9116 |
| JSON overhead ratio (%) | 21.15 ± 8.57 |
...
| --- | ---: | ---: | ---: |
| Throughput (analyses/s, higher better) | 3865.71 ± 811.36 | 2543.80 ± 69.61 | 1.52x (faster) |
| Throughput (chars/s, higher better) | 131047.62 ± 27505.16 | 86234.83 ± 2359.65 | 1.52x (faster) |
| Throughput (tokens/s, higher better) | 62237.96 ± 13062.92 | 40891.59 ± 1118.92 | 1.52x (faster) |
| Avg warm latency (ms, lower better) | 0.27 ± 0.06 | 0.39 ± 0.01 | 0.68x (faster) |
| Avg warm token latency (us/token, lower better) | 16.62 ± 3.96 | 24.47 ± 0.68 | 0.68x (faster) |

## Layered Throughput Breakdown

| Layer | Throughput (mean ± std, analyses/s) |
| --- | ---: |
| Flutter pure (`token_count`) | 3865.71 ± 811.36 |
| Flutter full (`json`) | 3094.32 ± 930.90 |
| kiwipiepy current API path (`analyze`) | 2543.80 ± 69.61 |

| Derived ratio | Value |
| --- | ---: |
| Flutter pure / kiwi | 1.52x (faster) |
| Flutter full / kiwi | 1.22x (faster) |
| Flutter boundary loss (full vs pure) | 19.95% |
...
| --- | ---: | ---: | ---: |
| Init time (ms, lower better) | median 4114.19, p95 4273.30 | median 1020.01, p95 1140.11 | 4.03x (slower) |
...
| ---: | ---: | ---: | ---: |
| 1 | 0.24 ± 0.01 | 0.96 ± 0.09 | 0.25x (slower) |
| 10 | 2.42 ± 0.08 | 9.59 ± 0.87 | 0.25x (slower) |
| 100 | 24.03 ± 0.79 | 92.73 ± 8.19 | 0.26x (slower) |
| 1000 | 227.05 ± 5.21 | 697.44 ± 46.98 | 0.33x (slower) |

## Per-Trial Raw Snapshot

| Trial | Flutter init (ms) | Kiwi init (ms) | Flutter warm analyses/s | Kiwi warm analyses/s |
| ---: | ---: | ---: | ---: | ---: |
| 1 | 4009.80 | 1153.46 | 2930.26 | 2575.77 |
| 2 | 4290.97 | 961.23 | 4288.66 | 2591.68 |
| 3 | 4114.19 | 1020.01 | 4378.22 | 2463.95 |
