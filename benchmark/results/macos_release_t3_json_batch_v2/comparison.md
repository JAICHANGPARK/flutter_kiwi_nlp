...
| generated_at_utc (first trial) | 2026-02-18T02:49:33.760118Z | 2026-02-18T02:49:36Z |
| trials | 3 | 3 |
...
| --- | ---: |
| Pure processing elapsed (ms) | 49.82 ± 0.70 |
| Full analyze elapsed (ms) | 78.95 ± 2.82 |
| JSON overhead elapsed (ms) | 29.13 ± 2.76 |
| JSON overhead per analysis (ms) | 0.0485 ± 0.0046 |
| JSON overhead per token (us) | 3.0154 ± 0.2859 |
| JSON overhead ratio (%) | 36.85 ± 2.27 |
...
| --- | ---: | ---: | ---: |
| Throughput (analyses/s, higher better) | 7606.26 ± 276.63 | 2439.44 ± 29.54 | 3.12x (faster) |
| Throughput (chars/s, higher better) | 257852.20 ± 9377.59 | 82697.06 ± 1001.31 | 3.12x (faster) |
| Throughput (tokens/s, higher better) | 122460.78 ± 4453.66 | 39214.02 ± 474.81 | 3.12x (faster) |
| Avg warm latency (ms, lower better) | 0.13 ± 0.00 | 0.41 ± 0.00 | 0.32x (faster) |
| Avg warm token latency (us/token, lower better) | 8.17 ± 0.29 | 25.50 ± 0.31 | 0.32x (faster) |

## Layered Throughput Breakdown

| Layer | Throughput (mean ± std, analyses/s) |
| --- | ---: |
| Flutter pure (`token_count`) | 12044.53 ± 168.39 |
| Flutter full (`json`) | 7606.26 ± 276.63 |
| kiwipiepy current API path (`analyze`) | 2439.44 ± 29.54 |

| Derived ratio | Value |
| --- | ---: |
| Flutter pure / kiwi | 4.94x (faster) |
| Flutter full / kiwi | 3.12x (faster) |
| Flutter boundary loss (full vs pure) | 36.85% |
...
| --- | ---: | ---: | ---: |
| Init time (ms, lower better) | median 1669.67, p95 1675.29 | median 894.68, p95 914.06 | 1.87x (slower) |
...
| ---: | ---: | ---: | ---: |
| 1 | 0.60 ± 0.01 | 1.11 ± 0.02 | 0.54x (slower) |
| 10 | 6.01 ± 0.06 | 11.10 ± 0.22 | 0.54x (slower) |
| 100 | 59.65 ± 0.60 | 106.60 ± 1.97 | 0.56x (slower) |
| 1000 | 557.18 ± 5.11 | 765.03 ± 8.08 | 0.73x (slower) |
