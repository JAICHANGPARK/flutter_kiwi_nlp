...
| generated_at_utc (first trial) | 2026-02-18T00:32:14.211282Z | 2026-02-18T00:32:16Z |
| trials | 5 | 5 |
...
| --- | ---: |
| Pure processing elapsed (ms) | 248.89 ± 18.92 |
| Full analyze elapsed (ms) | 285.40 ± 12.89 |
| JSON overhead elapsed (ms) | 36.52 ± 12.11 |
| JSON overhead per analysis (ms) | 0.0609 ± 0.0202 |
| JSON overhead per token (us) | 3.7800 ± 1.2540 |
| JSON overhead ratio (%) | 12.84 ± 4.46 |
...
| --- | ---: | ---: | ---: |
| Throughput (analyses/s, higher better) | 2422.31 ± 190.28 | 3352.24 ± 192.79 | 0.72x (slower) |
| Throughput (chars/s, higher better) | 82116.41 ± 6450.47 | 113640.90 ± 6535.66 | 0.72x (slower) |
| Throughput (tokens/s, higher better) | 38999.24 ± 3063.50 | 53887.24 ± 3099.14 | 0.72x (slower) |
| Avg warm latency (ms, lower better) | 0.41 ± 0.03 | 0.30 ± 0.02 | 1.39x (slower) |
| Avg warm token latency (us/token, lower better) | 25.76 ± 1.96 | 18.61 ± 1.11 | 1.38x (slower) |

## Layered Throughput Breakdown

| Layer | Throughput (mean ± std, analyses/s) |
| --- | ---: |
| Flutter pure (`token_count`) | 2422.31 ± 190.28 |
| Flutter full (`json`) | 2105.67 ± 93.14 |
| kiwipiepy current API path (`analyze`) | 3352.24 ± 192.79 |

| Derived ratio | Value |
| --- | ---: |
| Flutter pure / kiwi | 0.72x (slower) |
| Flutter full / kiwi | 0.63x (slower) |
| Flutter boundary loss (full vs pure) | 13.07% |
...
| --- | ---: | ---: | ---: |
| Init time (ms, lower better) | median 1358.27, p95 1496.69 | median 677.10, p95 711.15 | 2.01x (slower) |
...
| ---: | ---: | ---: | ---: |
| 1 | 0.72 ± 0.04 | 1.48 ± 0.06 | 0.49x (slower) |
| 10 | 7.21 ± 0.42 | 14.72 ± 0.59 | 0.49x (slower) |
| 100 | 70.17 ± 4.04 | 141.59 ± 5.39 | 0.50x (slower) |
| 1000 | 556.34 ± 32.34 | 1025.03 ± 30.53 | 0.54x (slower) |

## Per-Trial Raw Snapshot

| Trial | Flutter init (ms) | Kiwi init (ms) | Flutter warm analyses/s | Kiwi warm analyses/s |
| ---: | ---: | ---: | ---: | ---: |
| 1 | 1418.87 | 686.95 | 2276.97 | 3494.62 |
| 2 | 1358.27 | 677.10 | 2280.40 | 3494.45 |
| 3 | 1339.93 | 660.00 | 2673.07 | 3471.80 |
| 4 | 1304.74 | 644.59 | 2582.01 | 3072.02 |
| 5 | 1516.15 | 717.20 | 2299.11 | 3228.30 |
