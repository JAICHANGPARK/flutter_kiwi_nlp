...
| generated_at_utc (first trial) | 2026-02-18T00:17:41.331693Z | 2026-02-18T00:17:43Z |
| trials | 5 | 5 |
...
| --- | ---: |
| Pure processing elapsed (ms) | 236.67 ± 18.24 |
| Full analyze elapsed (ms) | 267.22 ± 25.79 |
| JSON overhead elapsed (ms) | 30.56 ± 7.82 |
| JSON overhead per analysis (ms) | 0.0509 ± 0.0130 |
| JSON overhead per token (us) | 3.1632 ± 0.8096 |
| JSON overhead ratio (%) | 11.31 ± 1.69 |
...
| --- | ---: | ---: | ---: |
| Throughput (analyses/s, higher better) | 2546.24 ± 179.08 | 3532.24 ± 167.92 | 0.72x (slower) |
| Throughput (chars/s, higher better) | 86317.60 ± 6070.90 | 119743.02 ± 5692.35 | 0.72x (slower) |
| Throughput (tokens/s, higher better) | 40994.49 ± 2883.23 | 56780.80 ± 2699.25 | 0.72x (slower) |
| Avg warm latency (ms, lower better) | 0.39 ± 0.03 | 0.28 ± 0.01 | 1.39x (slower) |
| Avg warm token latency (us/token, lower better) | 24.50 ± 1.89 | 17.64 ± 0.84 | 1.39x (slower) |

## Layered Throughput Breakdown

| Layer | Throughput (mean ± std, analyses/s) |
| --- | ---: |
| Flutter pure (`token_count`) | 2546.24 ± 179.08 |
| Flutter full (`json`) | 2260.25 ± 193.49 |
| kiwipiepy current API path (`analyze`) | 3532.24 ± 167.92 |

| Derived ratio | Value |
| --- | ---: |
| Flutter pure / kiwi | 0.72x (slower) |
| Flutter full / kiwi | 0.64x (slower) |
| Flutter boundary loss (full vs pure) | 11.23% |
...
| --- | ---: | ---: | ---: |
| Init time (ms, lower better) | median 1387.41, p95 1420.06 | median 976.95, p95 1104.95 | 1.42x (slower) |
...
| ---: | ---: | ---: | ---: |
| 1 | 0.72 ± 0.01 | 1.06 ± 0.16 | 0.68x (slower) |
| 10 | 7.16 ± 0.12 | 10.60 ± 1.57 | 0.68x (slower) |
| 100 | 69.84 ± 1.24 | 103.15 ± 14.81 | 0.68x (slower) |
| 1000 | 559.86 ± 15.62 | 813.32 ± 86.53 | 0.69x (slower) |
