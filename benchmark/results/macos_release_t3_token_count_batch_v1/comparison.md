...
| generated_at_utc (first trial) | 2026-02-18T02:25:31.153083Z | 2026-02-18T02:25:33Z |
| trials | 3 | 3 |
...
| --- | ---: |
| Pure processing elapsed (ms) | 319.61 ± 21.48 |
| Full analyze elapsed (ms) | 355.79 ± 20.43 |
| JSON overhead elapsed (ms) | 36.18 ± 3.10 |
| JSON overhead per analysis (ms) | 0.0603 ± 0.0052 |
| JSON overhead per token (us) | 3.7455 ± 0.3208 |
| JSON overhead ratio (%) | 10.20 ± 1.15 |
...
| --- | ---: | ---: | ---: |
| Throughput (analyses/s, higher better) | 1882.74 ± 121.94 | 2471.08 ± 196.17 | 0.76x (slower) |
| Throughput (chars/s, higher better) | 63824.91 ± 4133.78 | 83769.49 ± 6650.14 | 0.76x (slower) |
| Throughput (tokens/s, higher better) | 30312.13 ± 1963.24 | 39722.55 ± 3153.42 | 0.76x (slower) |
| Avg warm latency (ms, lower better) | 0.53 ± 0.04 | 0.41 ± 0.03 | 1.31x (slower) |
| Avg warm token latency (us/token, lower better) | 33.09 ± 2.22 | 25.28 ± 2.08 | 1.31x (slower) |

## Layered Throughput Breakdown

| Layer | Throughput (mean ± std, analyses/s) |
| --- | ---: |
| Flutter pure (`token_count`) | 1882.74 ± 121.94 |
| Flutter full (`json`) | 1689.99 ± 94.61 |
| kiwipiepy current API path (`analyze`) | 2471.08 ± 196.17 |

| Derived ratio | Value |
| --- | ---: |
| Flutter pure / kiwi | 0.76x (slower) |
| Flutter full / kiwi | 0.68x (slower) |
| Flutter boundary loss (full vs pure) | 10.24% |
...
| --- | ---: | ---: | ---: |
| Init time (ms, lower better) | median 1662.00, p95 1712.27 | median 876.22, p95 912.79 | 1.90x (slower) |
...
| ---: | ---: | ---: | ---: |
| 1 | 0.61 ± 0.03 | 1.14 ± 0.05 | 0.53x (slower) |
| 10 | 6.04 ± 0.26 | 11.36 ± 0.49 | 0.53x (slower) |
| 100 | 58.69 ± 2.47 | 109.02 ± 4.29 | 0.54x (slower) |
| 1000 | 458.06 ± 17.21 | 779.05 ± 17.03 | 0.59x (slower) |

## Per-Trial Raw Snapshot

| Trial | Flutter init (ms) | Kiwi init (ms) | Flutter warm analyses/s | Kiwi warm analyses/s |
| ---: | ---: | ---: | ---: | ---: |
| 1 | 1717.86 | 876.22 | 1963.76 | 2632.01 |
| 2 | 1577.54 | 839.65 | 1941.97 | 2252.56 |
| 3 | 1662.00 | 916.85 | 1742.50 | 2528.66 |
