...
| generated_at_utc (first trial) | 2026-02-17T23:25:35.823972Z | 2026-02-17T23:25:37Z |
| trials | 5 | 5 |
...
| --- | ---: |
| Pure processing elapsed (ms) | 246.96 ± 18.55 |
| Full analyze elapsed (ms) | 277.73 ± 18.82 |
| JSON overhead elapsed (ms) | 30.77 ± 10.62 |
| JSON overhead per analysis (ms) | 0.0513 ± 0.0177 |
| JSON overhead per token (us) | 3.1858 ± 1.0992 |
| JSON overhead ratio (%) | 11.06 ± 3.55 |
...
| --- | ---: | ---: | ---: |
| Throughput (analyses/s, higher better) | 2440.78 ± 186.51 | 3417.95 ± 324.44 | 0.71x (slower) |
| Throughput (chars/s, higher better) | 82742.36 ± 6322.81 | 115868.62 ± 10998.36 | 0.71x (slower) |
| Throughput (tokens/s, higher better) | 39296.52 ± 3002.87 | 54943.60 ± 5215.30 | 0.72x (slower) |
| Avg warm latency (ms, lower better) | 0.41 ± 0.03 | 0.29 ± 0.03 | 1.40x (slower) |
| Avg warm token latency (us/token, lower better) | 25.56 ± 1.92 | 18.34 ± 1.87 | 1.39x (slower) |

## Layered Throughput Breakdown

| Layer | Throughput (mean ± std, analyses/s) |
| --- | ---: |
| Flutter pure (`token_count`) | 2440.78 ± 186.51 |
| Flutter full (`json`) | 2168.81 ± 155.88 |
| kiwipiepy current API path (`analyze`) | 3417.95 ± 324.44 |

| Derived ratio | Value |
| --- | ---: |
| Flutter pure / kiwi | 0.71x (slower) |
| Flutter full / kiwi | 0.63x (slower) |
| Flutter boundary loss (full vs pure) | 11.14% |
...
| --- | ---: | ---: | ---: |
| Init time (ms, lower better) | median 1379.36, p95 1420.42 | median 703.02, p95 794.35 | 1.96x (slower) |
...
| ---: | ---: | ---: | ---: |
| 1 | 0.72 ± 0.01 | 1.42 ± 0.13 | 0.51x (slower) |
| 10 | 7.20 ± 0.15 | 14.12 ± 1.28 | 0.51x (slower) |
| 100 | 70.09 ± 1.46 | 136.14 ± 12.24 | 0.51x (slower) |
| 1000 | 556.62 ± 15.74 | 1001.03 ± 84.66 | 0.56x (slower) |

## Per-Trial Raw Snapshot

| Trial | Flutter init (ms) | Kiwi init (ms) | Flutter warm analyses/s | Kiwi warm analyses/s |
| ---: | ---: | ---: | ---: | ---: |
| 1 | 1361.94 | 703.02 | 2276.49 | 3701.92 |
| 2 | 1358.84 | 660.70 | 2707.08 | 3479.40 |
| 3 | 1379.36 | 808.54 | 2494.63 | 3313.41 |
| 4 | 1406.58 | 737.61 | 2477.29 | 2912.36 |
| 5 | 1423.88 | 639.94 | 2248.40 | 3682.66 |
