...
| generated_at_utc (first trial) | 2026-02-18T03:01:17.021874Z | 2026-02-18T03:01:19Z |
| trials | 3 | 3 |
...
| --- | ---: |
| Pure processing elapsed (ms) | 68.67 ± 31.90 |
| Full analyze elapsed (ms) | 122.14 ± 30.79 |
| JSON overhead elapsed (ms) | 53.47 ± 43.71 |
| JSON overhead per analysis (ms) | 0.0891 ± 0.0729 |
| JSON overhead per token (us) | 5.5352 ± 4.5250 |
| JSON overhead ratio (%) | 41.81 ± 25.87 |
...
| --- | ---: | ---: | ---: |
| Throughput (analyses/s, higher better) | 9890.53 ± 3756.49 | 2553.35 ± 61.83 | 3.87x (faster) |
| Throughput (chars/s, higher better) | 335288.96 ± 127345.03 | 86558.61 ± 2096.03 | 3.87x (faster) |
| Throughput (tokens/s, higher better) | 159237.53 ± 60479.50 | 41045.12 ± 993.92 | 3.88x (faster) |
| Avg warm latency (ms, lower better) | 0.11 ± 0.05 | 0.39 ± 0.01 | 0.29x (faster) |
| Avg warm token latency (us/token, lower better) | 7.11 ± 3.30 | 24.37 ± 0.58 | 0.29x (faster) |

## Layered Throughput Breakdown

| Layer | Throughput (mean ± std, analyses/s) |
| --- | ---: |
| Flutter pure (`token_count`) | 9890.53 ± 3756.49 |
| Flutter full (`json`) | 5150.22 ± 1424.86 |
| kiwipiepy current API path (`analyze`) | 2553.35 ± 61.83 |

| Derived ratio | Value |
| --- | ---: |
| Flutter pure / kiwi | 3.87x (faster) |
| Flutter full / kiwi | 2.02x (faster) |
| Flutter boundary loss (full vs pure) | 47.93% |
...
| --- | ---: | ---: | ---: |
| Init time (ms, lower better) | median 1740.17, p95 1746.64 | median 848.42, p95 885.88 | 2.05x (slower) |
...
| ---: | ---: | ---: | ---: |
| 1 | 0.58 ± 0.00 | 1.16 ± 0.03 | 0.50x (slower) |
| 10 | 5.75 ± 0.04 | 11.56 ± 0.32 | 0.50x (slower) |
| 100 | 57.17 ± 0.42 | 111.05 ± 2.87 | 0.51x (slower) |
| 1000 | 540.24 ± 15.79 | 797.83 ± 9.76 | 0.68x (slower) |

## Per-Trial Raw Snapshot

| Trial | Flutter init (ms) | Kiwi init (ms) | Flutter warm analyses/s | Kiwi warm analyses/s |
| ---: | ---: | ---: | ---: | ---: |
| 1 | 1740.17 | 848.42 | 5703.96 | 2508.81 |
| 2 | 1747.36 | 846.73 | 12966.52 | 2527.30 |
| 3 | 1725.47 | 890.04 | 11001.10 | 2623.94 |
