...
| generated_at_utc (first trial) | 2026-02-18T07:04:30.074700Z | 2026-02-18T07:04:34Z |
| trials | 3 | 3 |
...
| --- | ---: |
| Pure processing elapsed (ms) | 323.41 ± 1.71 |
| Full analyze elapsed (ms) | 362.07 ± 2.35 |
| JSON overhead elapsed (ms) | 38.66 ± 2.58 |
| JSON overhead per analysis (ms) | 0.0644 ± 0.0043 |
| JSON overhead per token (us) | 4.0023 ± 0.2667 |
| JSON overhead ratio (%) | 10.68 ± 0.66 |
...
| --- | ---: | ---: | ---: |
| Throughput (analyses/s, higher better) | 1855.28 ± 9.79 | 2502.68 ± 49.83 | 0.74x (slower) |
| Throughput (chars/s, higher better) | 62893.99 ± 331.73 | 84840.88 ± 1689.17 | 0.74x (slower) |
| Throughput (tokens/s, higher better) | 29870.01 ± 157.55 | 40230.59 ± 800.98 | 0.74x (slower) |
| Avg warm latency (ms, lower better) | 0.54 ± 0.00 | 0.40 ± 0.01 | 1.35x (slower) |
| Avg warm token latency (us/token, lower better) | 33.48 ± 0.18 | 24.86 ± 0.49 | 1.35x (slower) |

## Layered Throughput Breakdown

| Layer | Throughput (mean ± std, analyses/s) |
| --- | ---: |
| Flutter pure (`token_count`) | 1855.28 ± 9.79 |
| Flutter full (`json`) | 1657.19 ± 10.76 |
| kiwipiepy current API path (`analyze`) | 2502.68 ± 49.83 |

| Derived ratio | Value |
| --- | ---: |
| Flutter pure / kiwi | 0.74x (slower) |
| Flutter full / kiwi | 0.66x (slower) |
| Flutter boundary loss (full vs pure) | 10.68% |
...
| --- | ---: | ---: | ---: |
| Init time (ms, lower better) | median 3714.72, p95 3774.70 | median 936.95, p95 1110.89 | 3.96x (slower) |
...
| ---: | ---: | ---: | ---: |
| 1 | 0.27 ± 0.01 | 1.02 ± 0.11 | 0.27x (slower) |
| 10 | 2.70 ± 0.06 | 10.12 ± 1.14 | 0.27x (slower) |
| 100 | 26.61 ± 0.58 | 97.65 ± 10.70 | 0.27x (slower) |
| 1000 | 235.67 ± 4.50 | 721.86 ± 62.41 | 0.33x (slower) |

## Per-Trial Raw Snapshot

| Trial | Flutter init (ms) | Kiwi init (ms) | Flutter warm analyses/s | Kiwi warm analyses/s |
| ---: | ---: | ---: | ---: | ---: |
| 1 | 3781.37 | 1130.22 | 1863.71 | 2461.03 |
| 2 | 3714.72 | 936.95 | 1844.55 | 2489.14 |
| 3 | 3619.61 | 911.49 | 1857.59 | 2557.88 |
