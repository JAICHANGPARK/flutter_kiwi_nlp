...
| generated_at_utc (first trial) | 2026-02-18T02:38:55.850916Z | 2026-02-18T02:38:58Z |
| trials | 1 | 1 |
...
| --- | ---: |
| Pure processing elapsed (ms) | 42.76 ± 0.00 |
| Full analyze elapsed (ms) | 323.16 ± 0.00 |
| JSON overhead elapsed (ms) | 280.40 ± 0.00 |
| JSON overhead per analysis (ms) | 0.4673 ± 0.0000 |
| JSON overhead per token (us) | 29.0270 ± 0.0000 |
| JSON overhead ratio (%) | 86.77 ± 0.00 |
...
| --- | ---: | ---: | ---: |
| Throughput (analyses/s, higher better) | 14031.48 ± 0.00 | 2580.00 ± 0.00 | 5.44x (faster) |
| Throughput (chars/s, higher better) | 475667.08 ± 0.00 | 87462.16 ± 0.00 | 5.44x (faster) |
| Throughput (tokens/s, higher better) | 225906.78 ± 0.00 | 41473.58 ± 0.00 | 5.45x (faster) |
| Avg warm latency (ms, lower better) | 0.07 ± 0.00 | 0.39 ± 0.00 | 0.18x (faster) |
| Avg warm token latency (us/token, lower better) | 4.43 ± 0.00 | 24.11 ± 0.00 | 0.18x (faster) |

## Layered Throughput Breakdown

| Layer | Throughput (mean ± std, analyses/s) |
| --- | ---: |
| Flutter pure (`token_count`) | 14031.48 ± 0.00 |
| Flutter full (`json`) | 1856.65 ± 0.00 |
| kiwipiepy current API path (`analyze`) | 2580.00 ± 0.00 |

| Derived ratio | Value |
| --- | ---: |
| Flutter pure / kiwi | 5.44x (faster) |
| Flutter full / kiwi | 0.72x (slower) |
| Flutter boundary loss (full vs pure) | 86.77% |
...
| --- | ---: | ---: | ---: |
| Init time (ms, lower better) | median 1631.81, p95 1631.81 | median 890.52, p95 890.52 | 1.83x (slower) |
...
| ---: | ---: | ---: | ---: |
| 1 | 0.61 ± 0.00 | 1.12 ± 0.00 | 0.55x (slower) |
| 10 | 6.13 ± 0.00 | 11.18 ± 0.00 | 0.55x (slower) |
| 100 | 61.02 ± 0.00 | 107.61 ± 0.00 | 0.57x (slower) |
| 1000 | 587.17 ± 0.00 | 782.40 ± 0.00 | 0.75x (slower) |

## Per-Trial Raw Snapshot

| Trial | Flutter init (ms) | Kiwi init (ms) | Flutter warm analyses/s | Kiwi warm analyses/s |
| ---: | ---: | ---: | ---: | ---: |
| 1 | 1631.81 | 890.52 | 14031.48 | 2580.00 |
