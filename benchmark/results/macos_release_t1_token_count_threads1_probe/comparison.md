...
| generated_at_utc (first trial) | 2026-02-18T02:35:57.375794Z | 2026-02-18T02:35:59Z |
| trials | 1 | 1 |
...
| --- | ---: |
| Pure processing elapsed (ms) | 328.89 ± 0.00 |
| Full analyze elapsed (ms) | 375.57 ± 0.00 |
| JSON overhead elapsed (ms) | 46.68 ± 0.00 |
| JSON overhead per analysis (ms) | 0.0778 ± 0.0000 |
| JSON overhead per token (us) | 4.8318 ± 0.0000 |
| JSON overhead ratio (%) | 12.43 ± 0.00 |
...
| --- | ---: | ---: | ---: |
| Throughput (analyses/s, higher better) | 1824.30 ± 0.00 | 2643.73 ± 0.00 | 0.69x (slower) |
| Throughput (chars/s, higher better) | 61843.82 ± 0.00 | 89622.51 ± 0.00 | 0.69x (slower) |
| Throughput (tokens/s, higher better) | 29371.25 ± 0.00 | 42497.99 ± 0.00 | 0.69x (slower) |
| Avg warm latency (ms, lower better) | 0.55 ± 0.00 | 0.38 ± 0.00 | 1.45x (slower) |
| Avg warm token latency (us/token, lower better) | 34.05 ± 0.00 | 23.53 ± 0.00 | 1.45x (slower) |

## Layered Throughput Breakdown

| Layer | Throughput (mean ± std, analyses/s) |
| --- | ---: |
| Flutter pure (`token_count`) | 1824.30 ± 0.00 |
| Flutter full (`json`) | 1597.58 ± 0.00 |
| kiwipiepy current API path (`analyze`) | 2643.73 ± 0.00 |

| Derived ratio | Value |
| --- | ---: |
| Flutter pure / kiwi | 0.69x (slower) |
| Flutter full / kiwi | 0.60x (slower) |
| Flutter boundary loss (full vs pure) | 12.43% |
...
| --- | ---: | ---: | ---: |
| Init time (ms, lower better) | median 1752.31, p95 1752.31 | median 875.28, p95 875.28 | 2.00x (slower) |
...
| ---: | ---: | ---: | ---: |
| 1 | 0.57 ± 0.00 | 1.14 ± 0.00 | 0.50x (slower) |
| 10 | 5.69 ± 0.00 | 11.38 ± 0.00 | 0.50x (slower) |
| 100 | 55.34 ± 0.00 | 109.52 ± 0.00 | 0.51x (slower) |
| 1000 | 434.69 ± 0.00 | 797.74 ± 0.00 | 0.54x (slower) |

## Per-Trial Raw Snapshot

| Trial | Flutter init (ms) | Kiwi init (ms) | Flutter warm analyses/s | Kiwi warm analyses/s |
| ---: | ---: | ---: | ---: | ---: |
| 1 | 1752.31 | 875.28 | 1824.30 | 2643.73 |
