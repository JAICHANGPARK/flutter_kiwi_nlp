...
| generated_at_utc (first trial) | 2026-02-18T08:32:31.414963Z | 2026-02-18T08:32:34Z |
| trials | 3 | 3 |
...
| --- | ---: |
| Pure processing elapsed (ms) | 329.53 ± 8.68 |
| Full analyze elapsed (ms) | 388.37 ± 5.19 |
| JSON overhead elapsed (ms) | 58.84 ± 7.60 |
| JSON overhead per analysis (ms) | 0.0981 ± 0.0127 |
| JSON overhead per token (us) | 6.0812 ± 0.7856 |
| JSON overhead ratio (%) | 15.15 ± 1.93 |
...
| --- | ---: | ---: | ---: |
| Throughput (analyses/s, higher better) | 1821.60 ± 47.41 | 2765.91 ± 120.43 | 0.66x (slower) |
| Throughput (chars/s, higher better) | 61752.32 ± 1607.19 | 93764.26 ± 4082.57 | 0.66x (slower) |
| Throughput (tokens/s, higher better) | 29373.34 ± 764.48 | 44461.96 ± 1935.91 | 0.66x (slower) |
| Avg warm latency (ms, lower better) | 0.55 ± 0.01 | 0.36 ± 0.02 | 1.52x (slower) |
| Avg warm token latency (us/token, lower better) | 34.06 ± 0.90 | 22.52 ± 1.01 | 1.51x (slower) |

## Layered Throughput Breakdown

| Layer | Throughput (mean ± std, analyses/s) |
| --- | ---: |
| Flutter pure (`token_count`) | 1821.60 ± 47.41 |
| Flutter full (`json`) | 1545.12 ± 20.77 |
| kiwipiepy current API path (`analyze`) | 2765.91 ± 120.43 |

| Derived ratio | Value |
| --- | ---: |
| Flutter pure / kiwi | 0.66x (slower) |
| Flutter full / kiwi | 0.56x (slower) |
| Flutter boundary loss (full vs pure) | 15.18% |
...
| --- | ---: | ---: | ---: |
| Init time (ms, lower better) | median 2375.64, p95 3105.05 | median 897.47, p95 1038.60 | 2.65x (slower) |
...
| ---: | ---: | ---: | ---: |
| 1 | 0.39 ± 0.06 | 1.06 ± 0.10 | 0.36x (slower) |
| 10 | 3.86 ± 0.63 | 10.61 ± 1.00 | 0.36x (slower) |
| 100 | 37.85 ± 6.05 | 102.52 ± 9.35 | 0.37x (slower) |
| 1000 | 317.94 ± 42.81 | 767.45 ± 51.28 | 0.41x (slower) |

## Per-Trial Raw Snapshot

| Trial | Flutter init (ms) | Kiwi init (ms) | Flutter warm analyses/s | Kiwi warm analyses/s |
| ---: | ---: | ---: | ---: | ---: |
| 1 | 3186.10 | 1054.28 | 1858.05 | 2829.23 |
| 2 | 2351.61 | 883.24 | 1768.00 | 2841.47 |
| 3 | 2375.64 | 897.47 | 1838.76 | 2627.03 |
