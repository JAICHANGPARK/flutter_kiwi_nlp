...
| generated_at_utc (first trial) | 2026-02-18T00:13:52.904096Z | 2026-02-18T00:14:05Z |
| trials | 1 | 1 |
...
| --- | ---: |
| Pure processing elapsed (ms) | 245.14 ± 0.00 |
| Full analyze elapsed (ms) | 280.42 ± 0.00 |
| JSON overhead elapsed (ms) | 35.28 ± 0.00 |
| JSON overhead per analysis (ms) | 0.0588 ± 0.0000 |
| JSON overhead per token (us) | 3.6522 ± 0.0000 |
| JSON overhead ratio (%) | 12.58 ± 0.00 |
...
| --- | ---: | ---: | ---: |
| Throughput (analyses/s, higher better) | 2447.58 ± 0.00 | 3507.04 ± 0.00 | 0.70x (slower) |
| Throughput (chars/s, higher better) | 82973.00 ± 0.00 | 118888.59 ± 0.00 | 0.70x (slower) |
| Throughput (tokens/s, higher better) | 39406.05 ± 0.00 | 56375.64 ± 0.00 | 0.70x (slower) |
| Avg warm latency (ms, lower better) | 0.41 ± 0.00 | 0.29 ± 0.00 | 1.43x (slower) |
| Avg warm token latency (us/token, lower better) | 25.38 ± 0.00 | 17.74 ± 0.00 | 1.43x (slower) |

## Layered Throughput Breakdown

| Layer | Throughput (mean ± std, analyses/s) |
| --- | ---: |
| Flutter pure (`token_count`) | 2447.58 ± 0.00 |
| Flutter full (`json`) | 2139.65 ± 0.00 |
| kiwipiepy current API path (`analyze`) | 3507.04 ± 0.00 |

| Derived ratio | Value |
| --- | ---: |
| Flutter pure / kiwi | 0.70x (slower) |
| Flutter full / kiwi | 0.61x (slower) |
| Flutter boundary loss (full vs pure) | 12.58% |
...
| --- | ---: | ---: | ---: |
| Init time (ms, lower better) | median 3294.85, p95 3294.85 | median 739.97, p95 739.97 | 4.45x (slower) |
...
| ---: | ---: | ---: | ---: |
| 1 | 0.30 ± 0.00 | 1.35 ± 0.00 | 0.22x (slower) |
| 10 | 3.03 ± 0.00 | 13.46 ± 0.00 | 0.23x (slower) |
| 100 | 29.98 ± 0.00 | 130.13 ± 0.00 | 0.23x (slower) |
| 1000 | 270.02 ± 0.00 | 975.51 ± 0.00 | 0.28x (slower) |

## Per-Trial Raw Snapshot

| Trial | Flutter init (ms) | Kiwi init (ms) | Flutter warm analyses/s | Kiwi warm analyses/s |
| ---: | ---: | ---: | ---: | ---: |
| 1 | 3294.85 | 739.97 | 2447.58 | 3507.04 |
